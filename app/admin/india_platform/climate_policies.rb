ActiveAdmin.register_page 'India Platform Climate Policies' do
  include DataUploader::SharedAdmin

  section_name = 'climate_policies'
  ...
  controller do
    ...
    def s3_folder_path
      "#{CW_FILES_PREFIX}climate_policies"
    end

    def path
      admin_india_platform_climate_policies_path
    end
    ...
    def import_worker
      DataUploader::BaseImportWorker.perform_async(section.id, 'ImportClimatePolicies', current_admin_user.email)
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_india_platform_climate_policies_upload_datafile_path,
      download_path: admin_india_platform_climate_policies_download_datafiles_path,
      download_single_data_file_path:
          admin_india_platform_climate_policies_download_datafile_path,
      import_path: admin_india_platform_climate_policies_run_importer_path,
