ActiveAdmin.register_page 'India Platform Locations Members' do
  ...
  controller do
    ...
    def path
      admin_india_platform_locations_members_path
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_india_platform_locations_members_upload_datafile_path,
      download_path: admin_india_platform_locations_members_download_datafiles_path,
      download_single_data_file_path:
          admin_india_platform_locations_members_download_datafile_path,
      import_path: admin_india_platform_locations_members_run_importer_path,
