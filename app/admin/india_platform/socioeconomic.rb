ActiveAdmin.register_page 'India Platform Socioeconomic' do
  include DataUploader::SharedAdmin

  section_name = 'socioeconomic'
  ...
  controller do
    ...
    def s3_folder_path
      "#{CW_FILES_PREFIX}socioeconomic"
    end

    def path
      admin_india_platform_socioeconomic_path
    end
  ...
  content do
    render partial: 'data_uploader/admin/form_upload_datasets', locals: {
      ...
      upload_path: admin_india_platform_socioeconomic_upload_datafile_path,
      download_path: admin_india_platform_socioeconomic_download_datafiles_path,
      download_single_data_file_path:
          admin_india_platform_socioeconomic_download_datafile_path,
      import_path: admin_india_platform_socioeconomic_run_importer_path,
